...
void GameEngine::Render() const
{
	...
	glEnable(GL_BLEND);//アルファブレンディング,
	glBlendFunc(GL_SRC_ALPHA,GL_ONE_MINUS_SRC_ALPHA);//合成方法.
	glViewport(0, 0, width, height);		//謎
	glScissor(0, 0, width, height);			//謎
	...
	/*
	* オフスクリーンバッファを画面サイズのポリゴンに張り付けて出力する.
	*
	*/
